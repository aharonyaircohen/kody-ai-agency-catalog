...
The installed behavior must remain the current Web Release sequence: prepare a
...
Store activation patch. The existing Store Web Release solution owns ongoing
execution after that pull request is accepted.
